...
// CREDENCIALES ARDUINO CLOUD - NODO PUERTA
 
const char SSID_WIFI[]         = "CABLETECH3AF6";  // Red matriz directa sin repetidor
const char PASS_WIFI[]         = "kEueE3uJxY";       
const char DEVICE_LOGIN_NAME[] = "4db4a285-d602-453d-9e3d-d70c1efbd43c"; 
const char DEVICE_KEY[]        = "rj5isrleZrbXcKIhuHLSvyNq!"; 
...
void loop(){
  ...
  // Escaneo asíncrono rápido (10ms) para proteger la conexión IoT
  bool tarjeta = nfc.readPassiveTargetID(PN532_MIFARE_ISO14443A, uid, &uidLength, 10);
  ...
  // Gestión de alarma sin retardar el loop
  if(alarmaActiva){
